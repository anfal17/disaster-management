  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await set(ref(db, 'users/' + user.uid), {
        ...
        phone: phone,
        location: location,
        nearestReliefCenter: nearestReliefCenter,
        // Handle profile picture upload if needed
      });

      // Redirect to home page
      history.push('/home'); // or use window.location.href for a simple redirect
    } catch (error) {
        ...
        <div className="w-full bg-white rounded-lg shadow sm:max-w-xl">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <form className="space-y-4 md:space-y-6" onSubmit={handleRegister}>
              ...
              <div>
                <label htmlFor="nearest-relief-center" className="block mb-2 text-sm font-medium text-gray-900">Nearest local relief center</label>
                <select
